...
points.add(point0, point1, point2);
labelGroup.add(label0, label1, label2);
...
let gimbalPath = './Modelos_GLTF/marco_sim.gltf';
...
function animate() {
  ...
  // Aplicar rotaciones SOLO a pivotes (muy rápido)
