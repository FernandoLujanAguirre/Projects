...
renderer.setAnimationLoop(() => {
    ...
    const Sec2 = new THREE.Euler(0, t4, 0, 'XYZ');
    const Sec3 = new THREE.Euler(t5, 0, 0, 'XYZ');
    ...
    const M = createTrail(new THREE.Vector3(0, 0, 0), new THREE.Vector3(Mx * 20, My * 20, Mz * 20));
