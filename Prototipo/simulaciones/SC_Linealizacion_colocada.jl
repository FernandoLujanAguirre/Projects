...
open("./Prototipo/simulaciones/datos_GCMRA_PRIMSA_Linealizacion_Colocada.json", "w") do io
    write(io, json_str)
end  
...
savefig(pos, "./Prototipo/simulaciones/Graficas/Linealizacion_colocada.svg")
