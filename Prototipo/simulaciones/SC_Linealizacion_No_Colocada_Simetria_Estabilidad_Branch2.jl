...
#PARAMETROS
    ...
    function soft_sat(x::AbstractVector, lim::Real, gain::Real=1.0)
...
M22bi = inv(M22bar);#
h3bar = h3 - M31*M11i*h1;   #
M32bar = M32 - M31*M11i*M12;#
M33bar = M33 - M31*M11i*M13;#

h1b = h1 - M12*M22bi*h2bar;
M13bar = M13 - M12*M22bi*M23bar
...
#e = qd - u[1:2]
#ep = -du[1:2]
#v1 = Kp*e + Kd*ep - M11i*M13bar*M33ti*μ
#v1 = -[1.0sin(-q1d + u[1])
#       1.0*sin(-q2d + u[2])]


#v3 = -pinv(M13bar)*(M11*v1 + h1b)
Kp = diagm([1000,1000])
Kd = diagm([1000,1000])
e = qd - u[4:5]
ep = -du[4:5]
