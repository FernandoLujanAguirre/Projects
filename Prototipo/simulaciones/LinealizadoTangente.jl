using Symbolics
setprecision(BigFloat, 1; base=10)
#satelite
Ixs = 0.033581;
Iys = 0.033147;
Izs = 0.006921
...
u = [u[1],u[2],u[3],u[4],u[5],u[6],u[7],u[8],u[9],u[10]];
du = [du[1],du[2],du[3],du[4],du[5],du[6],du[7],du[8],du[9],du[10]];

f = M \ (-C * du[1:5]);

du[1:5] .= u[6:10];
du[6:10] .= f + M \[0;0;0;τ₄;τ₅];

Differential(f[1])(u[1])