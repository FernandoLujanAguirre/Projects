...
#Posiciones
x_range = (0, )
traces1 = PlotlyJS.scatter(x=tiempo, y=t1, mode="lines",name="t1(t)",aspect_ratio=1)
traces2 = PlotlyJS.scatter(x=tiempo, y=t2, mode="lines",name="t2(t)",aspect_ratio=1)
traces3 = PlotlyJS.scatter(x=tiempo, y=t3, mode="lines",name="t3(t)",aspect_ratio=1)
traces4 = PlotlyJS.scatter(x=tiempo, y=t4, mode="lines",name="t4(t)",aspect_ratio=1)
traces5 = PlotlyJS.scatter(x=tiempo, y=t5, mode="lines",name="t5(t)",aspect_ratio=1)
...
pos = plot([traces1,traces2,traces3,traces4,traces5], Layout(title="Posiciones Sistema completo"))
