...
#sensibilidad = 1.0%
c11 = -0.026*u[7]*sin(2*u[2])+-2.2E-4*u[8]*sin(2*u[3])+-2.2E-4*u[8]*cos(2*u[2])*sin(2*u[3])+5.2E-6*u[9]*sin(2*u[2])*cos(u[3])*cos(2*u[4])+-1.3E-6*u[9]*sin(2*u[4])+3.9E-6*u[9]*cos(2*u[2])*sin(2*u[4])+5.2E-6*u[7]*cos(2*u[2])*cos(u[3])*sin(2*u[4])+1.3E-6*u[9]*cos(2*u[3])*sin(2*u[4])+1.3E-6*u[9]*cos(2*u[2])*cos(2*u[3])*sin(2*u[4])+-1.1E-6*u[10]*sin(2*u[3])*sin(u[4])*cos(2*u[5])+-1.1E-6*u[10]*cos(2*u[2])*sin(2*u[3])*sin(u[4])*cos(2*u[5])+8.6E-7*u[9]*cos(2*u[2])*sin(2*u[4])*cos(2*u[5])+-2.9E-7*u[10]*sin(2*u[5])+8.6E-7*u[10]*cos(2*u[2])*sin(2*u[5])+-8.6E-7*u[10]*cos(2*u[3])*sin(2*u[5])+-8.6E-7*u[10]*cos(2*u[2])*cos(2*u[3])*sin(2*u[5])+-2.3E-6*u[7]*cos(2*u[2])*sin(u[3])*cos(u[4])*sin(2*u[5])+8.6E-7*u[10]*cos(2*u[2])*cos(2*u[4])*sin(2*u[5])
c12 = -0.0069*u[8]*cos(u[2])+-8.5E-6*u[9]*sin(u[2])*sin(u[3])+-4.4E-4*u[8]*cos(u[2])*cos(2*u[3])+2.2E-4*u[7]*sin(u[2])*sin(2*u[3])+-3.2E-6*u[10]*sin(u[2])*cos(u[3])*cos(u[4])+-3.2E-6*u[10]*cos(u[2])*sin(u[4])+-5.2E-6*u[9]*sin(u[2])*sin(u[3])*cos(2*u[4])+-2.6E-6*u[7]*cos(u[2])*sin(u[3])*sin(2*u[4])+-2.6E-6*u[9]*cos(u[2])*sin(2*u[3])*sin(2*u[4])+1.1E-6*u[9]*sin(u[2])*sin(u[3])*cos(2*u[5])+-2.3E-6*u[10]*sin(u[2])*cos(u[3])*cos(u[4])*cos(2*u[5])+-2.3E-6*u[10]*cos(u[2])*cos(2*u[3])*sin(u[4])*cos(2*u[5])+-1.1E-6*u[9]*sin(u[2])*sin(u[3])*cos(2*u[4])*cos(2*u[5])+1.7E-6*u[10]*cos(u[2])*sin(2*u[3])*sin(2*u[5])+-1.1E-6*u[9]*cos(u[2])*cos(u[4])*sin(2*u[5])+-1.1E-6*u[7]*cos(u[2])*cos(u[3])*cos(u[4])*sin(2*u[5])+-1.1E-6*u[9]*cos(u[2])*cos(2*u[3])*cos(u[4])*sin(2*u[5])+2.3E-6*u[9]*sin(u[2])*cos(u[3])*sin(u[4])*sin(2*u[5])+1.1E-6*u[7]*sin(u[2])*cos(2*u[3])*sin(u[4])*sin(2*u[5])+-5.7E-7*u[10]*cos(u[2])*sin(2*u[3])*cos(2*u[4])*sin(2*u[5])+1.1E-6*u[10]*sin(u[2])*sin(u[3])*sin(2*u[4])*sin(2*u[5])
...
c21 = 0.0069*u[8]*cos(u[2])+0.013*u[6]*sin(2*u[2])+-4.4E-4*u[8]*cos(u[2])*cos(2*u[3])+3.3E-6*u[10]*cos(u[2])*sin(u[4])+-2.6E-6*u[9]*cos(u[2])*sin(2*u[3])*sin(2*u[4])+-2.3E-6*u[10]*cos(u[2])*cos(2*u[3])*sin(u[4])*cos(2*u[5])+1.7E-6*u[10]*cos(u[2])*sin(2*u[3])*sin(2*u[5])+1.1E-6*u[9]*cos(u[2])*cos(u[4])*sin(2*u[5])+-1.1E-6*u[9]*cos(u[2])*cos(2*u[3])*cos(u[4])*sin(2*u[5])
...
c31 = -0.0069*u[7]*cos(u[2])+-8.5E-6*u[9]*cos(u[2])*cos(u[3])+4.4E-4*u[7]*cos(u[2])*cos(2*u[3])+1.1E-4*u[6]*sin(2*u[3])+1.1E-4*u[6]*cos(2*u[2])*sin(2*u[3])+-5.2E-6*u[9]*cos(u[2])*cos(u[3])*cos(2*u[4])+5.2E-6*u[9]*sin(u[2])*sin(2*u[4])+1.1E-6*u[10]*sin(u[2])*sin(2*u[5])+5.7E-7*u[6]*cos(2*u[3])*sin(u[4])*sin(2*u[5])+5.7E-7*u[6]*cos(2*u[2])*cos(2*u[3])*sin(u[4])*sin(2*u[5])+1.1E-6*u[10]*sin(u[2])*cos(2*u[4])*sin(2*u[5])
