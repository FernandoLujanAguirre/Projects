...
function rotor(du,u,p,t)
    ...
    #Sistema reducido
#c11 =+-1.3E-6*sin(2*u[4])*u[9]+3.9E-6*cos(2*u[2])*sin(2*u[4])*u[9]+1.3E-6*cos(2*u[3])*sin(2*u[4])*u[9]+1.3E-6*cos(2*u[2])*cos(2*u[3])*sin(2*u[4])*u[9]+8.6E-7*cos(2*u[2])*sin(2*u[4])*cos(2*u[5])*u[9]
#c12 =+-3.2E-6*u[10]*cos(u[2])*sin(u[4])+-2.3E-6*u[10]*cos(u[2])*cos(2*u[3])*sin(u[4])*cos(2*u[5])+-0.0069*cos(u[2])*u[8]+-2.6E-6*cos(u[2])*sin(2*u[3])*sin(2*u[4])*u[9]+-1.1E-6*cos(u[2])*cos(u[4])*sin(2*u[5])*u[9]+-1.1E-6*cos(u[2])*cos(2*u[3])*cos(u[4])*sin(2*u[5])*u[9]
#c13 =+8.5E-6*cos(u[2])*cos(u[3])*u[9]+-5.2E-6*cos(u[2])*cos(u[3])*cos(2*u[4])*u[9]+-1.1E-6*cos(u[2])*cos(u[3])*cos(2*u[5])*u[9]+-1.1E-6*cos(u[2])*cos(u[3])*cos(2*u[4])*cos(2*u[5])*u[9]
...
#c15 = 0
#
#c21 =+3.3E-6*u[10]*cos(u[2])*sin(u[4])+-2.3E-6*u[10]*cos(u[2])*cos(2*u[3])*sin(u[4])*cos(2*u[5])+0.0069*cos(u[2])*u[8]+-2.6E-6*cos(u[2])*sin(2*u[3])*sin(2*u[4])*u[9]+1.1E-6*cos(u[2])*cos(u[4])*sin(2*u[5])*u[9]+-1.1E-6*cos(u[2])*cos(2*u[3])*cos(u[4])*sin(2*u[5])*u[9]
#c22 =+1.7E-6*u[10]*cos(2*u[3])*sin(2*u[5])+2.6E-6*sin(2*u[4])*u[9]+-2.6E-6*cos(2*u[3])*sin(2*u[4])*u[9]+5.7E-7*sin(2*u[4])*cos(2*u[5])*u[9]+-5.7E-7*cos(2*u[3])*sin(2*u[4])*cos(2*u[5])*u[9]
...
#c24 =+3.3E-6*u[10]*sin(u[3])*sin(u[4])+2.3E-6*u[10]*cos(u[3])*sin(2*u[5])
#c25 = 0
#
#c31 =+-8.5E-6*cos(u[2])*cos(u[3])*u[9]+-5.2E-6*cos(u[2])*cos(u[3])*cos(2*u[4])*u[9]+1.1E-6*cos(u[2])*cos(u[3])*cos(2*u[5])*u[9]+-1.1E-6*cos(u[2])*cos(u[3])*cos(2*u[4])*cos(2*u[5])*u[9]
#c32 =+3.3E-6*u[10]*cos(u[3])*cos(u[4])+2.3E-6*u[10]*cos(u[3])*cos(u[4])*cos(2*u[5])+8.5E-6*sin(u[3])*u[9]+5.2E-6*sin(u[3])*cos(2*u[4])*u[9]+-2.3E-6*cos(u[3])*sin(u[4])*sin(2*u[5])*u[9]
#c33 =+-5.2E-6*sin(2*u[4])*u[9]+-1.1E-6*sin(2*u[4])*cos(2*u[5])*u[9]
...
#c42 =+-3.3E-6*u[10]*sin(u[3])*sin(u[4])+2.3E-6*u[10]*cos(u[3])*sin(2*u[5])
#c43 =+-3.3E-6*u[10]*cos(u[4])+2.3E-6*u[10]*cos(u[4])*cos(2*u[5])
#c44 =+u[10]
#c45 = 0
#
#c51 =+-3.3E-6*cos(u[2])*cos(u[3])*sin(u[4])*u[9]+2.3E-6*cos(u[2])*cos(u[3])*sin(u[4])*cos(2*u[5])*u[9]
...
du4_0 = 110.0 #110rad/2 = 1050 rpm's
