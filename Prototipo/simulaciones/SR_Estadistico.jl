...
function rotor(du,u,p,t)
    ...
    m12 = -2.2E-4*cos(u[2])*sin(2*u[3])+-2.6E-6*sin(u[2])*sin(u[3])*sin(2*u[4])+-5.7E-7*sin(u[2])*sin(u[3])*sin(2*u[4])*cos(2*u[5])
    m13 = -0.0069*sin(u[2])
    ...
    m21 = -2.2E-4*cos(u[2])*sin(2*u[3])+-2.6E-6*sin(u[2])*sin(u[3])*sin(2*u[4])+-5.7E-7*sin(u[2])*sin(u[3])*sin(2*u[4])*cos(2*u[5])
    m22 = 0.033
    ...
    c11 = -0.026*u[7]*sin(2*u[2])+-2.2E-4*u[8]*sin(2*u[3])+-2.2E-4*u[8]*cos(2*u[2])*sin(2*u[3])+-1.3E-6*u[9]*sin(2*u[4])+3.9E-6*u[9]*cos(2*u[2])*sin(2*u[4])+5.2E-6*u[7]*cos(2*u[2])*cos(u[3])*sin(2*u[4])+1.3E-6*u[9]*cos(2*u[3])*sin(2*u[4])+1.3E-6*u[9]*cos(2*u[2])*cos(2*u[3])*sin(2*u[4])+-1.1E-6*u[10]*sin(2*u[3])*sin(u[4])*cos(2*u[5])+-1.1E-6*u[10]*cos(2*u[2])*sin(2*u[3])*sin(u[4])*cos(2*u[5])+-2.9E-7*u[9]*sin(2*u[4])*cos(2*u[5])+8.6E-7*u[9]*cos(2*u[2])*sin(2*u[4])*cos(2*u[5])+1.1E-6*u[7]*cos(2*u[2])*cos(u[3])*sin(2*u[4])*cos(2*u[5])+-2.9E-7*u[10]*sin(2*u[5])+8.6E-7*u[10]*cos(2*u[2])*sin(2*u[5])+-8.6E-7*u[10]*cos(2*u[3])*sin(2*u[5])+-8.6E-7*u[10]*cos(2*u[2])*cos(2*u[3])*sin(2*u[5])+-2.3E-6*u[7]*cos(2*u[2])*sin(u[3])*cos(u[4])*sin(2*u[5])+-5.7E-7*u[9]*sin(2*u[3])*cos(u[4])*sin(2*u[5])+-5.7E-7*u[9]*cos(2*u[2])*sin(2*u[3])*cos(u[4])*sin(2*u[5])+-2.9E-7*u[10]*cos(2*u[4])*sin(2*u[5])+8.6E-7*u[10]*cos(2*u[2])*cos(2*u[4])*sin(2*u[5])
    c12 = -0.0069*u[8]*cos(u[2])+-8.5E-6*u[9]*sin(u[2])*sin(u[3])+-4.4E-4*u[8]*cos(u[2])*cos(2*u[3])+2.2E-4*u[7]*sin(u[2])*sin(2*u[3])
    ...
    c22 = 4.4E-4*u[8]*sin(2*u[3])+2.6E-6*u[9]*sin(2*u[4])+-2.6E-6*u[9]*cos(2*u[3])*sin(2*u[4])+2.3E-6*u[10]*sin(2*u[3])*sin(u[4])*cos(2*u[5])+5.7E-7*u[10]*sin(2*u[5])+1.7E-6*u[10]*cos(2*u[3])*sin(2*u[5])+1.1E-6*u[9]*sin(2*u[3])*cos(u[4])*sin(2*u[5])+2.3E-6*u[8]*cos(2*u[3])*sin(u[4])*sin(2*u[5])+5.7E-7*u[10]*cos(2*u[4])*sin(2*u[5])+-5.7E-7*u[10]*cos(2*u[3])*cos(2*u[4])*sin(2*u[5])
    ...
    c32 = 8.5E-6*u[9]*sin(u[3])+-2.2E-4*u[7]*sin(2*u[3])+3.3E-6*u[10]*cos(u[3])*cos(u[4])+5.2E-6*u[9]*sin(u[3])*cos(2*u[4])+-1.1E-6*u[9]*sin(u[3])*cos(2*u[5])+2.3E-6*u[10]*cos(u[3])*cos(u[4])*cos(2*u[5])+1.1E-6*u[9]*sin(u[3])*cos(2*u[4])*cos(2*u[5])+-2.3E-6*u[9]*cos(u[3])*sin(u[4])*sin(2*u[5])+-1.1E-6*u[7]*cos(2*u[3])*sin(u[4])*sin(2*u[5])
    c33 = -5.2E-6*u[9]*sin(2*u[4])+-1.1E-6*u[10]*sin(2*u[5])+-1.1E-6*u[10]*cos(2*u[4])*sin(2*u[5])
...
pos = plot([traces1,traces2,traces3,traces4,traces5], Layout(title="Posiciones Sistema Reducido Estadistico"))
